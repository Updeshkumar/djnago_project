...
def aboutus(request):
    return render(request, 'About us _ asiyaiheavyvehicle.html')

def services(request):
    return render(request, 'Services _ asiyaiheavyvehicle.html')

def contactus(request):
    return render(request, 'Contact us _ asiyaiheavyvehicle.html')

def rentaleque(request):
    return render(request, 'rentalequipment.html')